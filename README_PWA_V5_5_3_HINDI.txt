MoneyWise GitHub PWA v5.5.3 — FORCE APP LAUNCHER

WHY THIS VERSION
- The GitHub Pages URL was showing an older "MoneyWise CFL Project Monthly Report" dashboard.
- v5.5.3 does NOT iframe or cache dashboard HTML.
...
6. Open:
   https://regionalcflmis.github.io/moneywise-app/?v=5531
7. If an installed old PWA still opens the dashboard, remove that old home-screen/app shortcut once and install again after opening v5.5.3.
