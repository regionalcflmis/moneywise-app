MoneyWise PWA v5.7.0

ZIP ki SABHI files GitHub repository ke ROOT me upload/replace karein.
Test URL:
...
2. Browser me ?v=5701 URL open karein.
3. Phir dubara Install/Add to Home Screen karein.
