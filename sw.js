const CACHE='moneywise-pwa-shell-v4.7.0-r2';
const CORE=['./','./index.html','./404.html','./config.js?v=4702','./manifest.webmanifest?v=4702','./offline.html','./icon-192.png?v=4702','./icon-512.png?v=4702','./apple-touch-icon.png?v=4702'];
